...
public class TrajectoryGenerator
{
            ...
            double goal_heading)
    {
        ...
        {
        case StepStrategy:
            traj = generateWithStep(config, goal_pos);
            break;
        case TrapezoidalStrategy:
            traj = generateWithTrapezoidal(config, start_vel, goal_vel, goal_pos);
            break;
        case SCurvesStrategy:
            traj = generateWithSCurves(config, goal_pos);
            break;
        default:
            traj = null;
            break;
    ...
    private static Trajectory generateWithStep(Config config, double goal_pos)
    {
