    ...
    public String serialize(Path path)
    {
        ...
        for (int i = 0; i < left.size(); ++i)
        {
            ...
            content += String.format(
                    ...
                    left_segment.pos, left_segment.vel, left_segment.acc, left_segment.jerk,
                    left_segment.heading, left_segment.dt, left_segment.x, left_segment.y,
                    right_segment.pos, right_segment.vel, right_segment.acc, right_segment.jerk,
                    right_segment.heading, right_segment.dt, right_segment.x, right_segment.y);
        }
