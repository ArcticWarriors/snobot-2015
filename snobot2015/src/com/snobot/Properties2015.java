...
public class Properties2015
{
    ...
    public static final DoubleProperty sXBOX_JOYSTICK_STACKER_UP = new DoubleProperty("XboxJoystickStackerUp", .2);
    public static final DoubleProperty sXBOX_JOYSTICK_STACKER_DOWN = new DoubleProperty("XboxJoystickStackerDown", -.2);
    ...
    public static final StringProperty sAUTON_DIR = new StringProperty("AutonDir");
    ...
    public static final StringProperty sPATH_DIR = new StringProperty("PathDir");
