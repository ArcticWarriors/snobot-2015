...
public abstract class BaseCoordinateWidget extends AutoUpdateWidget
{
    ...
    public BaseCoordinateWidget(boolean aDebug, FieldProperties aFieldProperties) {
        ...
        mModeProperty.add(sAllPropertyText, sAllPropertyText);
        mModeProperty.add(sFadePropertyText, sFadePropertyText);
        mModeProperty.add(sRainbowPropertyText, sRainbowPropertyText);
        mModeProperty.add(sSinglePropertyText, sSinglePropertyText);
